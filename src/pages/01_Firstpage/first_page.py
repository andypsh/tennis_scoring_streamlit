    ...
    with st.expander("🚀 2단계: 교류전 대진표 생성", expanded=st.session_state.match_data.empty):
        ...
        if st.button("🔥 대진표 생성 및 시트 덮어쓰기"):
            schedule_data = {
                ...
                "1코트": [
                    "[남복] 예준/소휘 (3.5) vs 병호/동희 (2.5)", "[혼복] 성혁/민영 (3.6) vs 익성/성희 (3.0)",
                    "[남복] 성혁/소휘 (5.5) vs 경랑/병호 (4.0)", "[혼복] 소휘/문정 (4.0) vs 동희/새롬 (2.5)",
                    "[남복] 성혁/두영 (4.5) vs 익성/재환 (5.5)", "[혼복] 예준/민영 (1.1) vs 경랑/은채 (4.0)",
                    "[남복] 성혁/현준 (5.5) vs 재환/경랑 (5.5)", "[혼복] 규찬/문정 (3.0) vs 태훈/은채 (4.0)"
                ],
                "2코트": [
                    "[남복] 현준/규찬 (3.5) vs 태훈/재환 (5.5)", "[여복] 혜린/유진 (1.5) vs 은채/새롬 (2.5)",
                    "[남복] 현준/두영 (3.5) vs 태훈/익성(5.5)", "[혼복] 현준/유진 (3.0) vs 경랑/승은 (4.5)",
                    "[혼복] 소휘/혜린 (4.5) vs 태훈/승은 (3.0)", "[혼복] 규찬/문정 (3.0) vs 태훈/새롬 (4.0)",
                    "[남복] 예준/두영 (2.0) vs 동희/익성 (3.0)", "[여복] 유진/혜린 (1.5) vs 새롬/성희 (2.5)"
                ],
                "3코트": [
                    "[여복] 문정/유진 (2.5) vs 승은/은채 (3.0)", "[남복] 예준/두영 (2.0) vs 경랑/동희 (4.0)",
                    "[여복] 민영/혜린 (0.6) vs 승은/성희 (3.0)", "[남복] 규찬/예준 (2.5) vs 재환/병호 (4.0)",
                    "[여복] 민영/문정 (1.5) vs 은채/성희 (3.0)", "[남복] 성혁/현준 (6.0) vs 재환/동희 (4.0)",
                    "[여복] 민영/유진 (1.1) vs 승은/성희 (3.0)", "[남복] 소휘/두영 (3.5) vs 익성/병호 (3.0)"
                ]
            }
            matches = []
