...
schedule_data = {
    ...
    "1코트": [
        "[A] 제당A-올네A (남단)", "[A] 제당A-올네A (남복)", "[A] ENT-B-올영A (남단)", "[A] 제당A-CM-B (남복)",
        "[A] 제당A-올영A (남단)", "[A] 제당A-올영A (남복)", "[A] CM-B-ENT-B (남단)", "6강 PO1 (남단)", "4강 1 (남단)", "결승 (남단)"
    ],
    "2코트": [
        "[A] CM-B-올영A (남단)", "[A] 제당A-올네A (여복)", "[A] 올네A-CM-B (남단)", "[A] 제당A-CM-B (여복)",
        "[A] ENT-B-올네A (남단)", "[A] 제당A-올영A (여복)", "[A] 제당A-ENT-B (남복)", "6강 PO1 (남복)", "4강 1 (남복)", "결승 (남복)"
    ],
    "3코트": [
        "[A] ENT-B-제당A (여복)", "[A] CM-B-올영A (남복)", "[B] 대통-제당B (남단)", "[A] ENT-B-올영A (남복)",
        "[B] 제당B-ENT-A (남단)", "[A] ENT-B-올네A (남복)", "[A] 제당A-ENT-B (여복)", "6강 PO1 (여복)", "4강 1 (여복)", "결승 (여복)"
    ],
    "4코트": [
        "[B] CM-A-ENT-A (남단)", "[B] CM-A-ENT-A (남복)", "[A] 제당A-CM-B (남단)", "[B] 대통-CM-A (남단)",
        "[B] CM-A-올영B (남단)", "[A] 제당A-ENT-B (남단)", "[B] ENT-A-대통 (남단)", "6강 PO2 (남단)", "4강 2 (남단)", "3,4위전 (남단)"
    ],
    "5코트": [
        "[B] 대통-올영B (남단)", "[B] CM-A-ENT-A (여복)", "[B] 올영B-ENT-A (남단)", "[B] 대통-제당B (남복)",
        "[A] CM-B-ENT-B (남복)", "[B] 제당B-ENT-A (남복)", "[B] CM-A-올영B (여복)", "6강 PO2 (남복)", "4강 2 (남복)", "3,4위전 (남복)"
    ],
    "6코트": [
        "[B] 제당B-CM-A (여복)", "[B] 대통-올영B (남복)", "[A] CM-B-올영A (여복)", "[B] ENT-A-올영B (여복)",
        "[B] 대통-올영B (여복)", "[B] CM-A-올영B (남복)", "[B] ENT-A-제당B (여복)", "6강 PO2 (여복)", "4강 2 (여복)", "3,4위전 (여복)"
    ]
}
